                        ...
                        <div class="grid gap-4">
                            ...
                            <div id="main-image-container">
                                <img id="main-image"
                                    ...
                                    src="{{ asset('images/single-product/1.jpg') }}" alt="Main Product Image" />
                            </div>
                            <!-- Small Images -->
                            <div class="grid grid-cols-5 gap-4">
                                <div>
                                    <img onclick="changeImage(this)"
                                        data-full="{{ asset('images/single-product/1.jpg') }}"
                                ...
                                <div>
                                    <img onclick="changeImage(this)"
                                        data-full="{{ asset('images/single-product/2.jpg') }}"
                                ...
                                <div>
                                    <img onclick="changeImage(this)"
                                        data-full="{{ asset('images/single-product/3.jpg') }}"
                                ...
                                <div>
                                    <img onclick="changeImage(this)"
                                        data-full="{{ asset('images/single-product/4.jpg') }}"
                                ...
                                <div>
                                    <img onclick="changeImage(this)"
                                        data-full="{{ asset('images/single-product/5.jpg') }}"
            ...
            <div class="py-12">
                <div class="mt-10">
                    <div class="flex space-x-4" role="tablist">
                        <button id="description-tab" role="tab" aria-controls="description-content"
                            aria-selected="true" class="tab active">Description</button>
                        ...
                        <button id="size-shape-tab" role="tab" aria-controls="size-shape-content"
                            aria-selected="false" class="tab">Size & Shape</button>
                        <button id="reviews-tab" role="tab" aria-controls="reviews-content"
                            aria-selected="false" class="tab">Reviews (3)</button>
                    </div>
                    <div class="mt-8">
                        <div id="description-content" role="tabpanel" aria-labelledby="description-tab"
                            ...
                            <div class="flex flex-col lg:flex-row lg:space-x-8">
                                <div class="w-full lg:w-1/2">
                                    ...
                                    <p class="mb-4">These days, you can take your own inspiration and create
                                        something
                                ...
                                <div class="w-full lg:w-1/4">
                                    ...
                                    <p class="mb-2">Care instructions: <span class="font-semibold">Machine wash at
                                            30°C,
                                ...
                                <div class="w-full lg:w-1/4">
                                    ...
                                    <p class="mb-2">Sleeve length: <span class="font-semibold">Short sleeves</span>
                                    </p>
                                </div>
                            </div>
                        </div>
            ...
            <div class="flex flex-wrap -mx-4">
                ...
                <div class="w-full sm:w-1/6 px-4 mb-8">
                    ...
                    <ul>
                        ...
                        <li class="flex items-center mb-2">
                            <img src="{{ asset('images/social_icons/pinterest.svg') }}" alt="Instagram"
                                class="w-4 h-4 transition-transform transform hover:scale-110 mr-2">
                            <a href="#" class="hover:text-primary">Pinterest</a>
                        </li>
                        <li class="flex items-center mb-2">
                            <img src="{{ asset('images/social_icons/youtube.svg') }}" alt="Instagram"
                                class="w-4 h-4 transition-transform transform hover:scale-110 mr-2">
        ...
        <div class="py-6 border-t border-gray-line">
            <div class="container mx-auto px-4 flex flex-wrap justify-between items-center">
                ...
                <div class="w-full lg:w-1/4 text-center lg:text-right">
                    <img src="{{ asset('images/social_icons/paypal.svg') }}" alt="PayPal"
                        class="inline-block h-8 mr-2">
                    <img src="{{ asset('images/social_icons/stripe.svg') }}" alt="Stripe"
                        class="inline-block h-8 mr-2">
