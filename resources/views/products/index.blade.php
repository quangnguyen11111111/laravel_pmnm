...
<head>
    ...
    @vite(['resources/css/app.css','resources/css/custom.css','resources/css/styles.css', 'resources/js/app.js', 'resources/js/script.js'])
</head>
                      ...
                      <div class="space-y-4">
                          ...
                          <div class="flex items-center justify-between pb-4 border-b border-gray-line">
                              <div class="flex items-center">
                                  <img src="{{ asset('images/single-product/1.jpg') }}" alt="Product" class="h-12 w-12 object-cover rounded mr-2">
                                  <div>
                          ...
                          <div class="flex items-center justify-between">
                            <div class="flex items-center">
                                <img src="{{ asset('images/single-product/2.jpg') }}" alt="Product" class="h-12 w-12 object-cover rounded mr-2">
                                <div>
        ...
        <div class="main-slider swiper-container">
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <img src="{{ asset('images/main-slider/6.jpg') }}" alt="Product 1">
                ...
                <!-- Slide 2 -->
                <div class="swiper-slide">
                    <img src="{{ asset('images/main-slider/5.jpg') }}" alt="Product 6">
                    <div class="swiper-slide-content">
            ...
            <div class="flex flex-wrap -mx-4">
                ...
                <div class="w-full sm:w-1/2 lg:w-1/4 px-4 mb-8">
                  <div class="bg-white p-3 rounded-lg shadow-lg">
                    <img src="{{ asset('images/products/1.jpg') }}" alt="Product 1" class="w-full object-cover mb-4 rounded-lg">
                ...
                <div class="w-full sm:w-1/2 lg:w-1/4 px-4 mb-8">
                  <div class="bg-white p-3 rounded-lg shadow-lg">
                    <img src="{{ asset('images/products/2.jpg') }}" alt="Product 2" class="w-full object-cover mb-4 rounded-lg">
                ...
                <div class="w-full sm:w-1/2 lg:w-1/4 px-4 mb-8">
                  <div class="bg-white p-3 rounded-lg shadow-lg">
                    <img src="{{ asset('images/products/3.jpg') }}" alt="Product 3" class="w-full object-cover mb-4 rounded-lg">
                ...
                <div class="w-full sm:w-1/2 lg:w-1/4 px-4 mb-8">
                  <div class="bg-white p-3 rounded-lg shadow-lg">
                    <img src="{{ asset('images/products/4.jpg') }}" alt="Product 4" class="w-full object-cover mb-4 rounded-lg">
    ...
    <section id="latest-products" class="py-10">
        <div class="container mx-auto px-4">
            ...
            <div class="flex flex-wrap -mx-4">
                ...
                <div class="w-full sm:w-1/2 lg:w-1/4 px-4 mb-8">
                  <div class="bg-white p-3 rounded-lg shadow-lg">
                    <img src="{{ asset('images/products/5.jpg') }}" alt="Product 1" class="w-full object-cover mb-4 rounded-lg">
                ...
                <div class="w-full sm:w-1/2 lg:w-1/4 px-4 mb-8">
                  <div class="bg-white p-3 rounded-lg shadow-lg">
                    <img src="{{ asset('images/products/6.jpg') }}" alt="Product 2" class="w-full object-cover mb-4 rounded-lg">
                ...
                <div class="w-full sm:w-1/2 lg:w-1/4 px-4 mb-8">
                  <div class="bg-white p-3 rounded-lg shadow-lg">
                    <img src="{{ asset('images/products/7.jpg') }}" alt="Product 3" class="w-full object-cover mb-4 rounded-lg">
                ...
                <div class="w-full sm:w-1/2 lg:w-1/4 px-4 mb-8">
                  <div class="bg-white p-3 rounded-lg shadow-lg">
                    <img src="{{ asset('images/products/8.jpg') }}" alt="Product 4" class="w-full object-cover mb-4 rounded-lg">
            ...
            <div class="w-full sm:w-1/6 px-4 mb-8">
              ...
              <ul>
                <li class="flex items-center mb-2">
                  <img src="{{ asset('images/social_icons/facebook.svg') }}" alt="Facebook" class="w-4 h-4 transition-transform transform hover:scale-110 mr-2">
                  <a href="#" class="hover:text-primary">Facebook</a>
                </li>
                <li class="flex items-center mb-2">
                  <img src="{{ asset('images/social_icons/twitter.svg') }}" alt="Twitter" class="w-4 h-4 transition-transform transform hover:scale-110 mr-2">
                  <a href="#" class="hover:text-primary">Twitter</a>
                </li>
                <li class="flex items-center mb-2">
                  <img src="{{ asset('images/social_icons/instagram.svg') }}" alt="Instagram" class="w-4 h-4 transition-transform transform hover:scale-110 mr-2">
                  <a href="#" class="hover:text-primary">Instagram</a>
                </li>
                <li class="flex items-center mb-2">
                  <img src="{{ asset('images/social_icons/pinterest.svg') }}" alt="Instagram" class="w-4 h-4 transition-transform transform hover:scale-110 mr-2">
                  <a href="#" class="hover:text-primary">Pinterest</a>
                </li>
                <li class="flex items-center mb-2">
                  <img src="{{ asset('images/social_icons/youtube.svg') }}" alt="Instagram" class="w-4 h-4 transition-transform transform hover:scale-110 mr-2">
