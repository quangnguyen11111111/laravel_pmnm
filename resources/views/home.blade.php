    ...
    <div class="">
        ...
        <div class="flex flex-col gap-5 mt-10 ">
            <div class="bg-gray-300 rounded-lg p-3 text-black text-lg hover:text-blue-500 ">
                <a href="{{ route('products.index') }}">Đường dẫn tới trang quản lý sản phẩm</a>
            </div>
            <div class="bg-gray-300 rounded-lg p-3 text-black text-lg hover:text-blue-500 ">
            ...
            <div class="bg-gray-300 rounded-lg p-3 text-black text-lg hover:text-blue-500 ">
                <a href="{{ route('sinhvien', ['Nguyễn Việt Quang', '0313767']) }}">Đường dẫn tới thông tin sinh viên làm
                    bài</a>
            </div>
            <div class="bg-gray-300 rounded-lg p-3 text-black text-lg hover:text-blue-500 ">
            ...
            <div class="bg-gray-300 rounded-lg p-3 text-black text-lg hover:text-blue-500 ">
                <a href="{{ route('banco', 10) }}">Đường dẫn tới trang bàn cờ 10x10 </a>
            </div>
        </div>
    </div>
</body>
